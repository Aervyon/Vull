...
if (!config.prefix) { // If no config prefix
  console.log(colors.yellow('You didnt set a prefix. I have set a prefix for you though, it\'s "s!"')) // Warn the user
...
const bot = new Eris.CommandClient(config.token, { restMode: true }, { // Define the bot
